...
Background: members and events have been added to database
 ...
 Given John is in the database with the following information:
  ...
  | Hospital   | Oakland  | 2015-04-30 09:30:00.000 | 3        | 1              | help out!   | 2015-04-30 09:30:00.000 | 2015-04-30 10:30:00.000 |
  ...
  Scenario: Removing a member should bump up any waitlisted members
    ...
    And in the modal I click ""
    Then I should see "You have successfully removed Bob Builder from Hospital."
    When I click on the event "Hospital"
    Then I should see "Tom Train" under "Volunteers"
