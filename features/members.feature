Feature: Memebers Tab
	As a Hep B member or administrator 
	So that I can contact other members
...
Background: members have been added to database
 ...
 Given John is in the database with the following information:
  ...
  | Craig        | Hiller     | May 15, 2015  | 5555555555  | chiller@berkeley.edu | testtest    | yes      |    0     |
  ...
  When I go to the members tab for "Vin"
